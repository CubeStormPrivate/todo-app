    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <Field
                ...
                className={`text-gray-100 font-bold tracking-wide placeholder-opacity-90 placeholder-gray-100 bg-transparent border-0 border-b-2 border-gray-200 focus:border-gray-200 focus:ring-0 p-1 ${styles}`}
